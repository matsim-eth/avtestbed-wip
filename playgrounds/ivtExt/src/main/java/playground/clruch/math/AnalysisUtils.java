package playground.clruch.math;
...
public enum AnalysisUtils {
    ...
    // TODO check class BinCounts in the tensor lib
    public static Tensor binCount(Tensor tensor, Scalar binSize) {
    ...
    public static Scalar adaptBinSize(Tensor tensor, Scalar binSize, Scalar step) {
